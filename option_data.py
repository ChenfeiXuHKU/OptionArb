...
if __name__=="__main__":
    ...
    expiry_list = ['JAN18','FEB18','MAR19','APR18','MAY18','JUN18','JUL18','AUG18','SEP18','OCT18','NOV18','DEC18']
    maturity_list = [30,27,28,27,30,28,30,30,27,30,29, 28]
    
    special_list = ['2018-01-31','2018-02-28','2018-03-29','2018-04-30', '2018-05-31', '2018-06-29', \
